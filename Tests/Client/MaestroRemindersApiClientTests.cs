...
public partial class MaestroApiClientTests
{
    ...
    [Test]
    public async Task Reminders_should_get_for_user()
    {
        const long userId = 1;
        var remindersCreateList = new List<ReminderDto>
        {
    ...
    [Test]
    public async Task Reminders_should_get()
    {
        const long userId = 2;
    ...
    [Test]
    public async Task Reminders_should_get_for_user_after_exclusive_start_date_time()
    {
        const long userId = 3;
