...
public static class TelegramCommandPatterns
{
    ...
    public const string CreateScheduleCommandPattern = "/schedule, дата время начала, дата время конца, описание, overlap - если это расписание может пересекаться с другими, иначе ничего не пишите";
}