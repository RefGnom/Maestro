...
public interface IRemindersRepository
{
    ...
    Task<List<ReminderDbo>> GetForUserInTimeRangeAsync(RemindersForUserDtoWithTimeRange remindersForUserDto, long integratorId, CancellationToken cancellationToken);
